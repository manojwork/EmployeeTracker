...
<%
	...
	if (session.getAttribute("employee") == null && request.getAttribute("admin") == null){
...
<div class="container">
    ...
    <h2>Add Task</h2>
    <form method="post" action="<%=request.getContextPath()%>/EditEmpTask" onsubmit="return validate()">
    <div class="form-group">
            <label for="title">Employee id:</label>
            <input Style="outline:0;border:0;background-color:white;" name="empid" type="text" class="form-control" id="empid"  readonly >
        </div>
        <div class="form-group">
            <label for="title">Task id:</label>
            <input Style="outline:0;border:0;background-color:white;" name="taskid" type="text" class="form-control" id="taskid"  readonly >
        </div>
        <div class="form-group">
