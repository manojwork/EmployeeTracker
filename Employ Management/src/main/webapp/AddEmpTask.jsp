...
<div class="container">
    ...
    <h2>Add Task</h2>
    <form method="post" action="<%=request.getContextPath()%>/AddEmpTask" onsubmit="return validate()">
    <div class="form-group">
            <label for="title">Employee id:</label>
            <input Style="outline:0;border:0;background-color:white;" name="empid" type="text" class="form-control" id="id"  readonly >
        </div>
        <div class="form-group">
...
<script>
    ...
    var taskid = getUrlParameter("empid");
