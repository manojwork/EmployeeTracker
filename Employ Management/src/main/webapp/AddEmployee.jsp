...
<div class="container">
    ...
    <h2>Add Employee</h2>
    <form method="post" action="AddEmployee" onsubmit="return validate()">
        ...
        <div class="form-group">
            ...
            <div class="form-inline">
                <input name="project" type="text" class="form-control mr-2" id="project" placeholder="Project"  required>
            </div>
        </div>
        <div class="form-group">
            <label>Password:</label>
            <div class="form-inline">
                <input  name="password" type="text" class="form-control mr-2" id="password" placeholder="Password"  required>
            </div>
        </div>
